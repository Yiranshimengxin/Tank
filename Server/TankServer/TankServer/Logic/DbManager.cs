...
public class DbManager
{
    ...
    //连接mysql数据库
    public static bool Connect(string db, string id, int port, string user, string pw)
    {
        //创建MySqlConnection对象
        mysql = new MySqlConnection();
        //连接参数
        string s = string.Format("Database={0};Data Source={1};port={2};" + "User Id={3};Password={4}", db, id, port, user, pw);
    ...
    public static bool CreatePlayer(string id)
    {
        ...
        {
            Console.WriteLine("数据库 Create err, " + ex.ToString());
            return false;
        }
    }
    ...
    public static bool CheckPassword(string id, string pw)
    {
        ...
        {
            Console.WriteLine("数据库 CheckPassword err, " + ex.ToString());
            return false;
        }
    }
    ...
    public static bool UpdatePlayerData(string id, PlayerData playerData)
    {
        ...
        {
            Console.WriteLine("数据库 UpdatePlayerData err, " + ex.ToString());
            return false;
        }
    }
}
